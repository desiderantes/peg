...
#line 20 "/home/desiderantes/CLionProjects/peg/src/leg.leg"
...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  ...
  l8:;	  yy->__pos= yypos6; yy->__thunkpos= yythunkpos6;  if (!yymatchChar(yy, '\f')) goto l9;  goto l6;
  l9:;	  yy->__pos= yypos6; yy->__thunkpos= yythunkpos6;  if (!yy_end_of_line(yy)) goto l5;
  }
  l6:;	
...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  ...
  {  int yypos15= yy->__pos, yythunkpos15= yy->__thunkpos;  if (!yymatchChar(yy, '}')) goto l15;  goto l10;
  l15:;	  yy->__pos= yypos15; yy->__thunkpos= yythunkpos15;
  }
  {  int yypos16= yy->__pos, yythunkpos16= yy->__thunkpos;  if (!yy_end_of_line(yy)) goto l17;  goto l16;
  l17:;	  yy->__pos= yypos16; yy->__thunkpos= yythunkpos16;  if (!yymatchDot(yy)) goto l10;
  }
  l16:;	
  }
  l11:;	
...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  yyprintf((stderr, "%s\n", "range"));
  {  int yypos19= yy->__pos, yythunkpos19= yy->__thunkpos;  if (!yy_char(yy)) goto l20;  if (!yymatchChar(yy, '-')) goto l20;  if (!yy_char(yy)) goto l20;  goto l19;
  l20:;	  yy->__pos= yypos19; yy->__thunkpos= yythunkpos19;  if (!yy_char(yy)) goto l18;
  }
  l19:;	
...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  yyprintf((stderr, "%s\n", "char"));
  {  int yypos22= yy->__pos, yythunkpos22= yy->__thunkpos;  if (!yymatchChar(yy, '\\')) goto l23;  if (!yymatchClass(yy, (unsigned char *)"\000\000\000\000\204\040\000\000\000\000\000\070\146\100\124\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000")) goto l23;  goto l22;
  l23:;	  yy->__pos= yypos22; yy->__thunkpos= yythunkpos22;  if (!yymatchChar(yy, '\\')) goto l24;  if (!yymatchChar(yy, 'x')) goto l24;  if (!yymatchClass(yy, (unsigned char *)"\000\000\000\000\000\000\377\003\176\000\000\000\176\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000")) goto l24;  if (!yymatchClass(yy, (unsigned char *)"\000\000\000\000\000\000\377\003\176\000\000\000\176\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000")) goto l24;  goto l22;
  l24:;	  yy->__pos= yypos22; yy->__thunkpos= yythunkpos22;  if (!yymatchChar(yy, '\\')) goto l25;  if (!yymatchChar(yy, 'x')) goto l25;  if (!yymatchClass(yy, (unsigned char *)"\000\000\000\000\000\000\377\003\176\000\000\000\176\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000")) goto l25;  goto l22;
  l25:;	  yy->__pos= yypos22; yy->__thunkpos= yythunkpos22;  if (!yymatchChar(yy, '\\')) goto l26;  if (!yymatchClass(yy, (unsigned char *)"\000\000\000\000\000\000\017\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000")) goto l26;  if (!yymatchClass(yy, (unsigned char *)"\000\000\000\000\000\000\377\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000")) goto l26;  if (!yymatchClass(yy, (unsigned char *)"\000\000\000\000\000\000\377\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000")) goto l26;  goto l22;
  l26:;	  yy->__pos= yypos22; yy->__thunkpos= yythunkpos22;  if (!yymatchChar(yy, '\\')) goto l27;  if (!yymatchClass(yy, (unsigned char *)"\000\000\000\000\000\000\377\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000")) goto l27;
  {  int yypos28= yy->__pos, yythunkpos28= yy->__thunkpos;  if (!yymatchClass(yy, (unsigned char *)"\000\000\000\000\000\000\377\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000")) goto l28;  goto l29;
  l28:;	  yy->__pos= yypos28; yy->__thunkpos= yythunkpos28;
  }
  l29:;	  goto l22;
  l27:;	  yy->__pos= yypos22; yy->__thunkpos= yythunkpos22;
  {  int yypos30= yy->__pos, yythunkpos30= yy->__thunkpos;  if (!yymatchChar(yy, '\\')) goto l30;  goto l21;
...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  yyprintf((stderr, "%s\n", "END"));  if (!yymatchChar(yy, '>')) goto l31;  if (!yy__(yy)) goto l31;
...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  yyprintf((stderr, "%s\n", "BEGIN"));  if (!yymatchChar(yy, '<')) goto l32;  if (!yy__(yy)) goto l32;
...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  yyprintf((stderr, "%s\n", "DOT"));  if (!yymatchChar(yy, '.')) goto l33;  if (!yy__(yy)) goto l33;
...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  yyprintf((stderr, "%s\n", "class"));  if (!yymatchChar(yy, '[')) goto l34;  yyText(yy, yy->__begin, yy->__end);  {
...
#undef yyleng
  ...
  {  int yypos37= yy->__pos, yythunkpos37= yy->__thunkpos;  if (!yymatchChar(yy, ']')) goto l37;  goto l36;
  l37:;	  yy->__pos= yypos37; yy->__thunkpos= yythunkpos37;
  }  if (!yy_range(yy)) goto l36;  goto l35;
...
#undef yytext
#undef yyleng
  }  if (!yymatchChar(yy, ']')) goto l34;  if (!yy__(yy)) goto l34;
...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  yyprintf((stderr, "%s\n", "literal"));
  {  int yypos39= yy->__pos, yythunkpos39= yy->__thunkpos;  if (!yymatchClass(yy, (unsigned char *)"\000\000\000\000\200\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000")) goto l40;  yyText(yy, yy->__begin, yy->__end);  {
#define yytext yy->__text
#define yyleng yy->__textlen
...
#undef yyleng
  ...
  {  int yypos43= yy->__pos, yythunkpos43= yy->__thunkpos;  if (!yymatchClass(yy, (unsigned char *)"\000\000\000\000\200\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000")) goto l43;  goto l42;
...
#undef yytext
#undef yyleng
  }  if (!yymatchClass(yy, (unsigned char *)"\000\000\000\000\200\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000")) goto l40;  if (!yy__(yy)) goto l40;  goto l39;
  l40:;	  yy->__pos= yypos39; yy->__thunkpos= yythunkpos39;  if (!yymatchClass(yy, (unsigned char *)"\000\000\000\000\004\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000")) goto l38;  yyText(yy, yy->__begin, yy->__end);  {
#define yytext yy->__text
#define yyleng yy->__textlen
...
#undef yyleng
  ...
  {  int yypos46= yy->__pos, yythunkpos46= yy->__thunkpos;  if (!yymatchClass(yy, (unsigned char *)"\000\000\000\000\004\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000")) goto l46;  goto l45;
  l46:;	  yy->__pos= yypos46; yy->__thunkpos= yythunkpos46;
  }  if (!yy_char(yy)) goto l45;  goto l44;
...
#undef yytext
#undef yyleng
  }  if (!yymatchClass(yy, (unsigned char *)"\000\000\000\000\004\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000")) goto l38;  if (!yy__(yy)) goto l38;
  }
  l39:;	
...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  yyprintf((stderr, "%s\n", "CLOSE"));  if (!yymatchChar(yy, ')')) goto l47;  if (!yy__(yy)) goto l47;
...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  yyprintf((stderr, "%s\n", "OPEN"));  if (!yymatchChar(yy, '(')) goto l48;  if (!yy__(yy)) goto l48;
...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  yyprintf((stderr, "%s\n", "COLON"));  if (!yymatchChar(yy, ':')) goto l49;  if (!yy__(yy)) goto l49;
...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  yyprintf((stderr, "%s\n", "PLUS"));  if (!yymatchChar(yy, '+')) goto l50;  if (!yy__(yy)) goto l50;
...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  yyprintf((stderr, "%s\n", "STAR"));  if (!yymatchChar(yy, '*')) goto l51;  if (!yy__(yy)) goto l51;
...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  yyprintf((stderr, "%s\n", "QUESTION"));  if (!yymatchChar(yy, '?')) goto l52;  if (!yy__(yy)) goto l52;
...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  yyprintf((stderr, "%s\n", "primary"));
  {  int yypos54= yy->__pos, yythunkpos54= yy->__thunkpos;  if (!yy_identifier(yy)) goto l55;  yyDo(yy, yy_1_primary, yy->__begin, yy->__end);  if (!yy_COLON(yy)) goto l55;  if (!yy_identifier(yy)) goto l55;
  {  int yypos56= yy->__pos, yythunkpos56= yy->__thunkpos;  if (!yy_EQUAL(yy)) goto l56;  goto l55;
  l56:;	  yy->__pos= yypos56; yy->__thunkpos= yythunkpos56;
  }  yyDo(yy, yy_2_primary, yy->__begin, yy->__end);  goto l54;
  l55:;	  yy->__pos= yypos54; yy->__thunkpos= yythunkpos54;  if (!yy_identifier(yy)) goto l57;
  ...
  }  yyDo(yy, yy_3_primary, yy->__begin, yy->__end);  goto l54;
  l57:;	  yy->__pos= yypos54; yy->__thunkpos= yythunkpos54;  if (!yy_OPEN(yy)) goto l59;  if (!yy_expression(yy)) goto l59;  if (!yy_CLOSE(yy)) goto l59;  goto l54;
  l59:;	  yy->__pos= yypos54; yy->__thunkpos= yythunkpos54;  if (!yy_literal(yy)) goto l60;  yyDo(yy, yy_4_primary, yy->__begin, yy->__end);  goto l54;
  l60:;	  yy->__pos= yypos54; yy->__thunkpos= yythunkpos54;  if (!yy_class(yy)) goto l61;  yyDo(yy, yy_5_primary, yy->__begin, yy->__end);  goto l54;
  l61:;	  yy->__pos= yypos54; yy->__thunkpos= yythunkpos54;  if (!yy_DOT(yy)) goto l62;  yyDo(yy, yy_6_primary, yy->__begin, yy->__end);  goto l54;
  l62:;	  yy->__pos= yypos54; yy->__thunkpos= yythunkpos54;  if (!yy_action(yy)) goto l63;  yyDo(yy, yy_7_primary, yy->__begin, yy->__end);  goto l54;
  l63:;	  yy->__pos= yypos54; yy->__thunkpos= yythunkpos54;  if (!yy_BEGIN(yy)) goto l64;  yyDo(yy, yy_8_primary, yy->__begin, yy->__end);  goto l54;
  l64:;	  yy->__pos= yypos54; yy->__thunkpos= yythunkpos54;  if (!yy_END(yy)) goto l53;  yyDo(yy, yy_9_primary, yy->__begin, yy->__end);
  }
  l54:;	
...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  yyprintf((stderr, "%s\n", "NOT"));  if (!yymatchChar(yy, '!')) goto l65;  if (!yy__(yy)) goto l65;
...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  yyprintf((stderr, "%s\n", "suffix"));  if (!yy_primary(yy)) goto l66;
  {  int yypos67= yy->__pos, yythunkpos67= yy->__thunkpos;
  {  int yypos69= yy->__pos, yythunkpos69= yy->__thunkpos;  if (!yy_QUESTION(yy)) goto l70;  yyDo(yy, yy_1_suffix, yy->__begin, yy->__end);  goto l69;
  l70:;	  yy->__pos= yypos69; yy->__thunkpos= yythunkpos69;  if (!yy_STAR(yy)) goto l71;  yyDo(yy, yy_2_suffix, yy->__begin, yy->__end);  goto l69;
  l71:;	  yy->__pos= yypos69; yy->__thunkpos= yythunkpos69;  if (!yy_PLUS(yy)) goto l67;  yyDo(yy, yy_3_suffix, yy->__begin, yy->__end);
  }
  l69:;	  goto l68;
...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  yyprintf((stderr, "%s\n", "AND"));  if (!yymatchChar(yy, '&')) goto l72;  if (!yy__(yy)) goto l72;
...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  yyprintf((stderr, "%s\n", "AT"));  if (!yymatchChar(yy, '@')) goto l73;  if (!yy__(yy)) goto l73;
...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  yyprintf((stderr, "%s\n", "action"));  if (!yymatchChar(yy, '{')) goto l74;  yyDo(yy, yy_1_action, yy->__begin, yy->__end);  yyText(yy, yy->__begin, yy->__end);  {
#define yytext yy->__text
#define yyleng yy->__textlen
...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  yyprintf((stderr, "%s\n", "prefix"));
  {  int yypos79= yy->__pos, yythunkpos79= yy->__thunkpos;  if (!yy_AT(yy)) goto l80;  if (!yy_action(yy)) goto l80;  yyDo(yy, yy_1_prefix, yy->__begin, yy->__end);  goto l79;
  l80:;	  yy->__pos= yypos79; yy->__thunkpos= yythunkpos79;  if (!yy_AND(yy)) goto l81;  if (!yy_action(yy)) goto l81;  yyDo(yy, yy_2_prefix, yy->__begin, yy->__end);  goto l79;
  l81:;	  yy->__pos= yypos79; yy->__thunkpos= yythunkpos79;  if (!yy_AND(yy)) goto l82;  if (!yy_suffix(yy)) goto l82;  yyDo(yy, yy_3_prefix, yy->__begin, yy->__end);  goto l79;
  l82:;	  yy->__pos= yypos79; yy->__thunkpos= yythunkpos79;  if (!yy_NOT(yy)) goto l83;  if (!yy_suffix(yy)) goto l83;  yyDo(yy, yy_4_prefix, yy->__begin, yy->__end);  goto l79;
  l83:;	  yy->__pos= yypos79; yy->__thunkpos= yythunkpos79;  if (!yy_suffix(yy)) goto l78;
  }
  l79:;	
...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  yyprintf((stderr, "%s\n", "error"));  if (!yy_prefix(yy)) goto l84;
  {  int yypos85= yy->__pos, yythunkpos85= yy->__thunkpos;  if (!yy_TILDE(yy)) goto l85;  if (!yy_action(yy)) goto l85;  yyDo(yy, yy_1_error, yy->__begin, yy->__end);  goto l86;
...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  yyprintf((stderr, "%s\n", "BAR"));  if (!yymatchChar(yy, '|')) goto l87;  if (!yy__(yy)) goto l87;
...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  yyprintf((stderr, "%s\n", "sequence"));  if (!yy_error(yy)) goto l88;
  l89:;	
  {  int yypos90= yy->__pos, yythunkpos90= yy->__thunkpos;  if (!yy_error(yy)) goto l90;  yyDo(yy, yy_1_sequence, yy->__begin, yy->__end);  goto l89;
...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  yyprintf((stderr, "%s\n", "SEMICOLON"));  if (!yymatchChar(yy, ';')) goto l91;  if (!yy__(yy)) goto l91;
...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  ...
  l93:;	
  {  int yypos94= yy->__pos, yythunkpos94= yy->__thunkpos;  if (!yy_BAR(yy)) goto l94;  if (!yy_sequence(yy)) goto l94;  yyDo(yy, yy_1_expression, yy->__begin, yy->__end);  goto l93;
...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  yyprintf((stderr, "%s\n", "EQUAL"));  if (!yymatchChar(yy, '=')) goto l95;  if (!yy__(yy)) goto l95;
...
#undef yytext
#undef yyleng
  }  if (!yymatchClass(yy, (unsigned char *)"\000\000\000\000\000\040\000\000\376\377\377\207\376\377\377\007\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000")) goto l96;
  l97:;	
  {  int yypos98= yy->__pos, yythunkpos98= yy->__thunkpos;  if (!yymatchClass(yy, (unsigned char *)"\000\000\000\000\000\040\377\003\376\377\377\207\376\377\377\007\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000")) goto l98;  goto l97;
...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  yyprintf((stderr, "%s\n", "RPERCENT"));  if (!yymatchString(yy, "%}")) goto l99;  if (!yy__(yy)) goto l99;
...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  yyprintf((stderr, "%s\n", "end_of_line"));
  {  int yypos101= yy->__pos, yythunkpos101= yy->__thunkpos;  if (!yymatchString(yy, "\r\n")) goto l102;  goto l101;
  l102:;	  yy->__pos= yypos101; yy->__thunkpos= yythunkpos101;  if (!yymatchChar(yy, '\n')) goto l103;  goto l101;
  l103:;	  yy->__pos= yypos101; yy->__thunkpos= yythunkpos101;  if (!yymatchChar(yy, '\r')) goto l100;
  }
  l101:;	  yyDo(yy, yy_1_end_of_line, yy->__begin, yy->__end);
...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  yyprintf((stderr, "%s\n", "trailer"));  if (!yymatchString(yy, "%%")) goto l106;  yyDo(yy, yy_1_trailer, yy->__begin, yy->__end);  yyText(yy, yy->__begin, yy->__end);  {
#define yytext yy->__text
#define yyleng yy->__textlen
...
#undef yyleng
  ...
  l107:;	
  {  int yypos108= yy->__pos, yythunkpos108= yy->__thunkpos;  if (!yymatchDot(yy)) goto l108;  goto l107;
...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  yyprintf((stderr, "%s\n", "definition"));  if (!yy_identifier(yy)) goto l109;  yyDo(yy, yy_1_definition, yy->__begin, yy->__end);  if (!yy_EQUAL(yy)) goto l109;  if (!yy_expression(yy)) goto l109;  yyDo(yy, yy_2_definition, yy->__begin, yy->__end);
  {  int yypos110= yy->__pos, yythunkpos110= yy->__thunkpos;  if (!yy_SEMICOLON(yy)) goto l110;  goto l111;
...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  yyprintf((stderr, "%s\n", "declaration"));  if (!yymatchString(yy, "%{")) goto l112;  yyDo(yy, yy_1_declaration, yy->__begin, yy->__end);  yyText(yy, yy->__begin, yy->__end);  {
#define yytext yy->__text
#define yyleng yy->__textlen
...
#undef yyleng
  ...
  {  int yypos115= yy->__pos, yythunkpos115= yy->__thunkpos;  if (!yymatchString(yy, "%}")) goto l115;  goto l114;
  l115:;	  yy->__pos= yypos115; yy->__thunkpos= yythunkpos115;
  }
  {  int yypos116= yy->__pos, yythunkpos116= yy->__thunkpos;  if (!yy_end_of_line(yy)) goto l117;  goto l116;
  l117:;	  yy->__pos= yypos116; yy->__thunkpos= yythunkpos116;  if (!yymatchDot(yy)) goto l114;
  }
  l116:;	  goto l113;
...
#undef yytext
#undef yyleng
  }  if (!yy_RPERCENT(yy)) goto l112;  yyDo(yy, yy_2_declaration, yy->__begin, yy->__end);
...
YY_RULE(int) yy__(yycontext *yy)
{
  ...
  {  int yypos121= yy->__pos, yythunkpos121= yy->__thunkpos;  if (!yy_space(yy)) goto l122;  goto l121;
  l122:;	  yy->__pos= yypos121; yy->__thunkpos= yythunkpos121;  if (!yy_comment(yy)) goto l120;
  }
  l121:;	  goto l119;
...
{  int yypos0= yy->__pos, yythunkpos0= yy->__thunkpos;
  yyprintf((stderr, "%s\n", "grammar"));  if (!yy__(yy)) goto l123;
  {  int yypos126= yy->__pos, yythunkpos126= yy->__thunkpos;  if (!yy_declaration(yy)) goto l127;  goto l126;
  l127:;	  yy->__pos= yypos126; yy->__thunkpos= yythunkpos126;  if (!yy_definition(yy)) goto l123;
  }
  l126:;	
  l124:;	
  {  int yypos125= yy->__pos, yythunkpos125= yy->__thunkpos;
  {  int yypos128= yy->__pos, yythunkpos128= yy->__thunkpos;  if (!yy_declaration(yy)) goto l129;  goto l128;
  l129:;	  yy->__pos= yypos128; yy->__thunkpos= yythunkpos128;  if (!yy_definition(yy)) goto l125;
  }
  l128:;	  goto l124;
  l125:;	  yy->__pos= yypos125; yy->__thunkpos= yythunkpos125;
  }
  {  int yypos130= yy->__pos, yythunkpos130= yy->__thunkpos;  if (!yy_trailer(yy)) goto l130;  goto l131;
  l130:;	  yy->__pos= yypos130; yy->__thunkpos= yythunkpos130;
  }
  l131:;	  if (!yy_end_of_file(yy)) goto l123;
...
#endif
#line 163 "/home/desiderantes/CLionProjects/peg/src/leg.leg"
...
#            endif
  ...
  for (; headers;  headers= headers->next) {
    if (!nolinesFlag) fprintf(output, "#line %i \"%s\"\n", headers->line, fileName);
    fprintf(output, "%s\n", headers->text);
  }
